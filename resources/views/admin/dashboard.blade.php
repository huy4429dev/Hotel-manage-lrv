...
<div class="seaContainer">
  <h2 style="position:absolute; z-index:9999; top: 100px; left:50%; transform:translateX(-30%); color:white">
  - Không bao giơ dừng lại -
    <p class="text-right mt-3" style="font-size:18px"> Hotel Sea </p>
...
.seaContainer {
 ...
 .light {
	 ...
	 width: 500px;
	 height: 100px;
   background: linear-gradient(to left, #817e97, #ffc10726);
