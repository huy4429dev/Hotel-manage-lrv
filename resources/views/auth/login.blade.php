...
<style>
    ...
    #submit {
        ...
        padding: 3px 15px;
        border-radius: 5px;
        box-shadow: 1px 2px 3px #3332;
        color: whitesmoke;
    }
    #admin-login{
        box-shadow: 2px 2px 2px #3332, 2px 2px 5px #33333340, 2px 2px 8px #33333340;
    }
</style>
@stop
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ $dashboard_url }}">{!! config('adminlte.logo', '<b>Hotel</b>LTE') !!}</a>
    </div>
